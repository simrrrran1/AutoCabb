    ...
    <section class="container-fluid box col-lg-4 col-sm-10 col-xs-12 col-md-7 ml-lg-5 ml-md-5 pt-lg-4 mt-lg-4 pt-sm-0 mt-sm-0 mb-5 pb-3 pt-2">
      <div class="text-center">
        ...
        <form action="body.php" method="post">
          ...
          <div class="form-group  row feilds ">
            ...
            <select  class="form-control-plaintext col-sm-9 arro" id="cabtype">
              ...
              <option value="CedMicro" <?php if(isset($c)){ if($c== 'CedMicro') { ?>selected<?php } }?>>AutoMicro</option>
              <option value="CedMini" <?php if(isset($c)){ if($c== 'CedMini') { ?>selected<?php } }?>>AutoMini</option>
              <option value="CedRoyal" <?php if(isset($c)){ if($c== 'CedRoyal') { ?>selected<?php } }?>>AutoRoyal</option>
              <option value="CedSUV" <?php if(isset($c)){ if($c== 'CedSUV') { ?>selected<?php } }?>>AutoSUV</option>
            </select>
        </div>
        ...
        <div class="form-group  row feilds ">
          ...
          <p id="err" class="text-danger h6">*Luggage is not available in AutoMicro</p>
        </div>
